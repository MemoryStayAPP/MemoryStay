      ...
      <div className="flex flex-col items-center justify-center animate-FadeIn">
        ...
        <form className="flex flex-col items-center justify-center mt-4 gap-2" onSubmit={handleSubmit(onSubmit)}>
          <div className="relative">
            ...
            <label htmlFor="username" className="absolute text-[#6e7680] select-none placeholder-opacity-0 top-1 left-4 peer-focus:top-1 peer-placeholder-shown:top-[0.44rem] peer-placeholder-shown:text-xl peer-focus:text-xs font-bold text-xs transition-all">Email</label>
          </div>
          <div className="relative">
